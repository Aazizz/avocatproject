...
route.post("/updateservice", (req, res) => {
    ...
    client.query(
        "UPDATE servicetable SET nom=$1,lundi=$2,mardi=$3,mercredi=$4,jeudi=$5,vendredi=$6,samedi=$7,tribunale_id=$8 WHERE service_id=$9 ", [nom, lundi, mardi, mercredi, jeudi, vendredi, samedi, tribunale_id, id],
        (error, result) => {
            if (error) {
                console.log(error);
            } else {
